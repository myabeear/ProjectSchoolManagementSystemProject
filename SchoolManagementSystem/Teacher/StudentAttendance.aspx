...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container p-md-4 p-sm-4">
        ...
        <h3 class="text-c">Student's Attendance</h3>
     ...
     <label for="ddlSubject">Subject</label>
      ...
      <div class="col-md-6 col-lg-4 col-xl-3 col-md-offset-2 mb-3">
          <asp:Button ID="btnMarkAttend" runat="server" CssClass="btn btn-primary btn-block" BackColor="#5558C9" Text="Mark Attendance" OnClick="btnMarkAttendance_click" />
      </div>
 </div>
